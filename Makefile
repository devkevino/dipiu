#############################################################################
# Makefile for building: dipiu-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ? 5 25 09:35:16 2018
# Project:  dipiu-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile dipiu-qt.pro
#############################################################################
...
Makefile: dipiu-qt.pro  ../QT/4.8.6/mkspecs/default/qmake.conf ../QT/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile dipiu-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/dipiu/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/dipiu/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/dipiu/src/leveldb/libleveldb.a: FORCE
	cd C:/dipiu/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/dipiu/src/leveldb/libleveldb.a && ranlib C:/dipiu/src/leveldb/libmemenv.a
