...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dipiu " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dipiutools.com", "18.188.88.199"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dipiutools.com", "testnet-seed.dipiutools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dipiu is probably already running."), addrBind.ToString().c_str());
        else
